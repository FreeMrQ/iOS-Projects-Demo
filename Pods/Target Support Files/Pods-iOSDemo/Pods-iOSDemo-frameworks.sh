...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/../../FlutterDemo/flutter_demo/.ios/Flutter/engine/Flutter.framework"
  ...
  install_framework "${PODS_ROOT}/../../FlutterDemo/flutter_demo/.ios/Flutter/App.framework"
fi
